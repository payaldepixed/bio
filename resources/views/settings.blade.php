                        ...
                        <div class="row">
                            ...
                            {{-- <div class="col-xl-6">
                                <div class="mb-3">
                                    ...
                                    @if(@Auth::user()->avatar)
                                        <img height="50" width="50" src="{{Storage::disk(Config::get('constants.DISK'))->url(Auth::user()->avatar)}}">
                                    @endif
                                </div>
                            </div> --}}
                        </div>
                            ...
                            <div class="col-xl-6">
                                <div class="mb-3">
                                    ...
                                    <div>
                                        ...
                                        placeholder="Enter new password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" required>
                                        <small class="form-hint"></small>
                                    </div>
                                </div>
                            </div>
